...
def compute_scores(network: Network, updated_state: RunState, step_count: int, index_layer: int, index_head: int, heads_q: List[List[numpy.float32]]) -> List[numpy.float32]:
